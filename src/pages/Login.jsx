...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      localStorage.setItem('token', response.data.token); // Asegúrate que esta línea existe
      ...
      <div className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8 py-8">
        <div className="max-w-md w-full bg-white p-8 rounded-2xl shadow-lg relative z-10">
          <div>
            ...
            <h2 className="text-center text-3xl font-bold text-gray-900">Inicia sesión</h2>
